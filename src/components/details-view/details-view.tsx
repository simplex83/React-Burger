...
import { TCardItem, TOrder } from "../../services/types/types";

interface IDetailsView {
  data: TOrder;
}
export const DetailsView: FC<IDetailsView> = ({ data }) => {
  ...
  return (
    <>
      ...
      {data.status === "done" && <p className={styles.orderStatus}>Выполнен</p>}
      {data.status === "pending" && (
