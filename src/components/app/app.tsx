...
import { ProtectedRouteElement } from "../protect";
    ...
    <div className={`${styles.container}`}>
      ...
      <Routes location={background}>
        ...
        <Route
          ...
          element={<ProtectedRouteElement element={<ForgotPage />} />}
        />
        <Route
          path="/reset-password"
          element={<ProtectedRouteElement element={<ResetPage />} />}
        />
        <Route
          path="/profile"
        ...
        <Route
          ...
          element={<ProtectedRouteElement element={<FeedPageDetails />} />}
        />
